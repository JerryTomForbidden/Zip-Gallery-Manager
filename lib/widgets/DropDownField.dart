...
///I change this to List<String> for enforcment and to avoid passing it to _getChildren method which require a List<String>
///
...
class DropDownField extends FormField<String> {
            ...
            return Column(
              ...
              children: <Widget>[
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        validator: (String? newValue) {
                          ...
                          //!items.contains(newValue)) : why asking if a List<dynamic> contain a String?
                          if (items != null) {
                            if (strict &&
                                newValue!.isNotEmpty &&
                ...
                AnimatedContainer(
                  ...
                  height: !state._showdropdown
                      ? 0
                      : computeHeight(state._getChildren(state._items),
                          itemsVisibleInDropdown), //limit to default 3 items in dropdownlist view and then remaining scrolls
                  ...
                  child: ListView(
                    ...
                    // divideTiles doesn't support tiles: to be an empty array
                    children: items!.isNotEmpty &&
                            state._getChildren(state._items).isNotEmpty
  ...
  //height should depend on what we found (_searchText) and not arbitrary fixed to 3
  // but we can also fix a limit of 3 visible
  static double computeHeight(List itemsFound, int max) {
    return itemsFound.length > max ? max * 48.0 : itemsFound.length * 48.0;
  }
}
